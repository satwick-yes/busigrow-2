  ...
  return (
    <div className="w-full rounded-3xl border border-purple-200/60 dark:border-border bg-card/90 backdrop-blur-xl p-5 sm:p-8 md:p-10 space-y-6 shadow-sm">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-5 border-b border-purple-200/50 dark:border-purple-900/40">
        ...
        <div className="text-xs text-muted-foreground font-normal bg-purple-50/50 dark:bg-secondary/40 px-3 py-1.5 rounded-full border border-purple-200/40 dark:border-border/40 self-start sm:self-auto">
      ...
      <div
        ...
        className="relative w-full h-[380px] sm:h-[340px] rounded-2xl overflow-hidden cursor-ew-resize select-none border border-purple-200/60 dark:border-border/60"
      >
        {/* RIGHT (AFTER): Busigrow Unified Standard */}
        <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-primary/20 via-primary/10 to-background p-5 sm:p-8 flex flex-col justify-between items-end text-right text-foreground">
          <div className="flex items-center justify-between w-full">
            <span className="text-xs font-mono text-muted-foreground">Noida Direct Factory</span>
            <span className="px-3 py-1 rounded-full bg-purple-500/30 border border-purple-400 text-muted-foreground text-xs font-medium shadow-sm flex items-center gap-1.5">
          ...
          <div className="space-y-2.5 max-w-sm sm:max-w-md">
            <h4 className="text-xl sm:text-2xl font-light text-foreground tracking-tight leading-snug">
          ...
          <div className="grid grid-cols-3 gap-2 text-left w-full max-w-sm sm:max-w-md pt-3 border-t border-purple-500/20 text-xs text-muted-foreground">
        ...
        >
          ...
          <div className="w-full h-full min-w-[300px] flex flex-col justify-between p-5 sm:p-8 text-muted-foreground">
            <div className="flex items-center gap-2">
              <span className="px-3 py-1 rounded-full bg-zinc-800/90 border border-zinc-700 text-muted-foreground text-xs font-medium flex items-center gap-1.5">
            ...
            <div className="space-y-2.5 max-w-sm sm:max-w-md">
              <h4 className="text-xl sm:text-2xl font-light text-muted-foreground tracking-tight leading-snug">
            ...
            <div className="grid grid-cols-3 gap-2 text-left w-full max-w-sm sm:max-w-md pt-3 border-t border-zinc-800 text-xs text-muted-foreground">
              <div className="flex items-center gap-1">
        ...
        >
          <div className="w-8 h-8 rounded-full bg-purple-600 text-foreground shadow-[0_0_15px_rgba(168,85,247,0.8)] flex items-center justify-center border-2 border-white">
            <ArrowLeftRight className="w-3.5 h-3.5" />
          </div>
        </div>
      </div>
