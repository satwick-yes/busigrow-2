...
export function HeroCommandCenter() {
  ...
  return (
    <div className="w-full rounded-3xl border border-purple-200/60 dark:border-purple-900/50 bg-card/90 backdrop-blur-xl shadow-sm overflow-hidden transition-all">
      {/* Top Interactive Pillar Selector */}
      <div className="px-4 sm:px-6 py-3.5 border-b border-purple-200/50 dark:border-purple-900/40 bg-purple-50/50 dark:bg-purple-950/40 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        {/* 3 Pill Tabs */}
        <div className="flex items-center gap-1.5 bg-background/80 dark:bg-background/40 p-1 rounded-2xl border border-purple-200/60 dark:border-purple-800/40 w-full sm:w-auto">
          {PILLARS.map((pillar) => {
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
              <div className="space-y-2 max-w-2xl">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-100/70 dark:bg-purple-950/70 text-purple-700 dark:text-purple-300 text-xs font-medium border border-purple-300/50 dark:border-purple-800/50">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 shrink-0">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-medium transition-all shadow-sm"
                >
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-purple-50 dark:bg-purple-950/60 text-purple-700 dark:text-purple-300 border border-purple-200/80 dark:border-purple-800/60 text-xs font-medium hover:bg-purple-100 dark:hover:bg-purple-900/60 transition-all"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
              {currentPillar.highlights.map((item, idx) => (
                <div
                  key={idx}
                  className="p-3.5 rounded-2xl bg-purple-50/40 dark:bg-purple-950/30 border border-purple-200/50 dark:border-purple-900/30 space-y-1"
                >
            ...
            <div className="pt-4 border-t border-purple-100 dark:border-purple-900/40">
              <span className="text-xs font-mono text-purple-700 dark:text-purple-300 block mb-3 font-medium">
